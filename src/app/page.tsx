...
export default async function Home() {
  ...
  return (
    <div className="home">
      <section className="hero section-photo section-photo--softball">
      ...
      <section id="integration" className="section-photo section-photo--baseball" style={{ borderBottom: "1px solid var(--border)" }}>
        <div className="section-head">
